class Solution:
    ...
    def count4(self, num1: str, num2: str, min_sum: int, max_sum: int) -> int:
        mod = 10 ** 9 + 7
    ...
    def count5(self, num1: str, num2: str, min_sum: int, max_sum: int) -> int:
        mod = 10 ** 9 + 7
        ...
        return (count_valid_numbers(num2) - count_valid_numbers(str(int(num1) - 1))) % mod