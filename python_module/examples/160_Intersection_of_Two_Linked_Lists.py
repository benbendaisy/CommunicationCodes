...
class Solution:
    ...
    def getIntersectionNode(self, headA: ListNode, headB: ListNode) -> Optional[ListNode]:
        """
            Calculate la; the length of list A.
            Calculate lb; the length of list B.
            remove the length diff so that both links have the same length
            traverse the two links to find the intersection
        :param headA:
        :param headB:
        :return:
        """
