...
with open('/Users/bendaisyarthurannie/Downloads/input.txt', 'r', encoding='utf-8') as f:
    text = f.read()
    ...
    for iter in range(max_iters):
        ...
        if iter % eval_interval == 0 or iter == max_iters - 1:
            ...
            with torch.no_grad():
                ...
                print(f"sample output after step {iter}: {decode(m.generate(context, max_new_tokens=20)[0].tolist())}")
