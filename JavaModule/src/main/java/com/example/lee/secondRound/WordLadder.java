...
public class WordLadder {
    public int ladderLength(String start, String end, Set<String> dict) {
        if (null == start|| null == end || start.equals(end) || start.length() != end.length()) return 0;
                ...
                for (int j = 0; j < 26; j++) {
                    ...
                    if (c != ch) {
                        ...
                        if (newStr.equals(end)) {
                            return level + 1;
                        }else if (dict.contains(newStr) && visited.add(newStr)) {
                            queue.add(newStr);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(wordLadder.ladderLength("cet", "ism", dict));
    }
}
